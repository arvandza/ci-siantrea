...
<body>
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html">
                                <img src="<?= base_url() ?>/assets/images/logos.svg" alt="Logo" style="width: 32px; height: 32px" />
                            </a>
                            ...
                            <div class="navbar-btn d-none d-sm-inline-block">
                                <a class="main-btn" data-scroll-nav="0" href="<?= site_url('login') ?>" rel="nofollow">
                                    Masuk
                                </a>
                            </div>
                        </nav>
                    ...
                    <div class="col-lg-8">
                        <div class="header-hero-content text-center">
                            ...
                            <h2 class="header-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">
                                Sistem Informasi Antrean Bimbingan
                            </h2>
                            <p class="text wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.8s">
                                Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
                                diam nonumy eirmod tempor
                            </p>
                            <a href="#jadwal" class="main-btn page-scroll active wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="1.1s">
                                Lihat Jadwal
                            </a>
                        </div>
                        <!-- header hero content -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-hero-image text-center wow fadeIn" data-wow-duration="1.3s" data-wow-delay="1.4s">
                            <img src="<?= base_url() ?>/assets/images/queue.png" alt="hero" />
                        </div>
                        <!-- header hero image -->
                    </div>
                </div>
    ...
    <!--====== SERVICES PART START ======-->
    <section id="jadwal" class="services-area pt-120">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
            ...
            <!-- row -->
            <div class="row justify-content-center">
                <div class="card-body p-1 wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">
                ...
                <div class="card-footer text-right wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s" style="border-end-end-radius: 8px; border-end-start-radius: 8px">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="footer-about mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            <a class="logo" href="javascript:void(0)">
                                <img src="<?= base_url() ?>/assets/images/logos.svg" alt="logo" style="height: 48px; width: 48px" />
                            </a>
                            <p class="text">
