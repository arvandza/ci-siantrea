<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
                <a href="<?= site_url('kelola_dosen') ?>" class="nav-link"><i
                        class="fas fa-users"></i><span>Kelola Dosen</span></a>
            </li>
            <li class="nav-item dropdown">
                <a href="<?= site_url('kelola_antrean') ?>" class="nav-link"><i class="fas fa-th"></i> <span>Kelola Antrean</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="bootstrap-alert.html">Antrean</a></li>
                    <li><a class="nav-link" href="bootstrap-badge.html"></a></li>
            ...
            <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i> <span>Riwayat
                        Antrean</span></a>
                <ul class="dropdown-menu">
