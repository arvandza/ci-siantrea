                ...
                <section class="section">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <form action="<?= site_url('kelola_antrean/update/' . $antre['id']) ?>" method="post" class="needs-validation" novalidate="">
                                <?= csrf_field() ?>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select id="inputState" class="form-control" name="optionDosen" disabled>
                                                <option value="<?= $dosen['id'] ?>"><?php echo $dosen['dosen_nama'] ?></option>
                                            </select>
                                        </div>
                                        <div class="form-group">
