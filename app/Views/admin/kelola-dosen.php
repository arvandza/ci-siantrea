            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="#" class="btn btn-icon icon-left btn-primary mb-3" data-toggle="modal" data-target="#dosenModal"><i class="fas fa-user-plus"></i> Tambah
                            Dosen</a>
                    </div>
                    <div class="row">
                    ...
                    <div class="modal-content ">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama" placeholder="Nama Lengkap Dosen" name="nama" required>
                            </div>
                            <div class="form-group">
